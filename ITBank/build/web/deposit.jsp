    ...
    <body>
        ...
        <center>
            <form action="depositcode.jsp" method="post">
                <h1> Amount Deposit:- </h1><hr style="color: black;size: 10px;">
                    <div class="form-group">
                      <label for="amt">Enter Deposit Amount:- </label>
                      <input type="number" class="form-control" id="amt" placeholder="Enter Amount to Deposit..." name="amt" required>
                    </div>
                    <br>
                    <center><button id="ok" type="submit" class="btn btn-default" onclick="check()">Deposit Amount</button></center>
                    <br>
            </form>
        </center>
    </body>
